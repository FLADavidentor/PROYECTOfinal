...
int buscarCredenciales(char nickn[]);
...
int buscarCredenciales(char nick[])
{
    int posicion = 0;
    for (int i = 0; i < TamCred; i++)
    {
        if (strcmp(nick, Credenciales[i].nickname) == 0)
        {
            posicion = i;
            break;
        }
